...
public class ZoomJob extends ViewPortJob {
    ...
    public ZoomJob(ViewPortHandler viewPortHandler, float scaleX, float scaleY, float xValue, float yValue, Transformer trans, @Nullable YAxis.AxisDependency axis, View v) {
