...
public class LegendEntry {
     ...
     */
    public LegendEntry(@Nullable String label, Legend.LegendForm form, float formSize, float formLineWidth, @Nullable DashPathEffect formLineDashEffect, int formColor) {
        this.label = label;
        this.form = form;
